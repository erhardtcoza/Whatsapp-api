...
CREATE TABLE IF NOT EXISTS messages (
  ...
  customer_id INTEGER,     -- link if known
  seen INTEGER,            -- for unread count
  media_url TEXT,          -- for images/files (optional)
  location_json TEXT       -- for storing lat/lng JSON if location msg
);
